          ...
          children: <Widget>[
            Row(
              children: <Widget>[
                ...
                SizedBox(width: 20.w),
                Text(
                  i18n.translate('homeScreen.title.symptoms').toUpperCase(),
            ...
            ImageNetworkWidget(
              imageUrl: GraphicConstants.symptomsBanner,
              width: _screenWidth,
              height: _screenWidth * .85,
              fit: BoxFit.fitWidth,
              hasDefaultErrorBg: true,
            ),
            Text(
              i18n.translate('homeScreen.message.contact'),
