...
import 'package:corona_virus_app/domain/entities/language_reference_entity.dart';
import 'package:corona_virus_app/common/constants/date_time_format_constants.dart';
...
class S {
  ...
  Future<void> _loadLocaleData(Locale locale) async {
    final data = await rootBundle
        .loadString('res/languages/${locale.languageCode}.json');
